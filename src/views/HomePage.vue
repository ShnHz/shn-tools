<template>
  <div class="space-y-12">
    ...
    <div>
      <div class="max-w-xl mx-auto">
        <div class="relative group">
          <div
            class="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-200"
          ></div>
          <div class="relative">
            <Search
              class="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-muted-foreground transition-colors duration-200 group-focus-within:text-primary"
            />
            <input
              v-model="searchQuery"
              type="text"
    ...
    >
      <div class="text-left">
        <h2 class="text-2xl font-bold text-foreground mb-2">常用工具</h2>
        <p class="text-muted-foreground text-sm">精选最受欢迎的开发工具</p>
      </div>

      <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl"
      >
        <div
        ...
        >
          ...
          ></div>
          <div
            class="absolute bottom-0 left-0 w-16 h-16 bg-white/5 rounded-full -ml-8 -mb-8"
          ></div>
      ...
      <div class="flex flex-wrap gap-3 justify-center max-w-4xl mx-auto">
        ...
        >
          ...
          <div
            ...
            class="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
          ></div>
        </button>
    ...
    <div class="space-y-8">
      ...
      >
        <div class="relative mx-auto w-24 h-24">
          <div
            class="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full animate-ping"
          ></div>
          <div
            class="relative flex items-center justify-center w-24 h-24 rounded-full bg-muted/50 backdrop-blur-sm"
          >
